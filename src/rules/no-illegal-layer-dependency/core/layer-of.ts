 ...
 * заявляет. У цели импорта — все сегменты записанного пути: `@/modules/order` это баррель модуля, и
 * разворачивать его в `…/order/index.ts` нельзя, иначе самый канонический легальный импорт
 * репортился бы как нарушение.
 */
